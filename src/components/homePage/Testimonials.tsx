...
const Testimonials = () => {
  ...
  const items = [
    <div
      className="w-auto h-[460px] px-10 py-6 mb-20 bg-pink-100 rounded-md shadow text-center bor"
      style={{
  ...
  return (
    <div className="relative bg-white px-18 rounded-t-md w-full min-h-screen">
